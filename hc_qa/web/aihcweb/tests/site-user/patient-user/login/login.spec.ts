...
// doctor-user/login today. Segregated ahead of time since Doctor/Patient login validation may
// diverge later (see US017).

test.describe('Login (Patient)', () => {
  ...
  test('unauthenticated visitor to /patient-chat is redirected to /login', async ({ page, baseURL }) => {
