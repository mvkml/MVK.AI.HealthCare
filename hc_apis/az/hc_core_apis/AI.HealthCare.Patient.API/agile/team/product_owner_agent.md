...
- Liaison between business needs and dev team

## Owns
- `agile/product_owner/backlog/`
...
## Product Focus
- AI.HealthCare.Patient.API core features (TBD — nothing scoped yet beyond the project name implying patient-record management)
- Key integrations: TBD
- Domain modules: TBD (likely something like patient records, appointments, provider management — not yet confirmed with the user)
